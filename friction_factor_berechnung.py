...
#for r in (185233.9588537, 113980.637881 ):
 #   factor = colebrook.bntFriction(r , 2.3333333333333332e-05) #relative roughness (diameter = 300mm)
  #  print(r, " : ", factor)
    
#for r in (76830.04180484,  58299.34462035,  46515.04782926,  58866.3285119, 76902.8576652 ,  57057.92663783, ):
 #   factor = colebrook.bntFriction(r ,  2.8e-05) #diameter = 250mm
  #  print(r, " : ", factor)
    
#for r in ( 44067.40891871, 37784.22298257):
 #   factor = colebrook.bntFriction(r , 3.5000000000000004e-05) #diameter = 200mm
  #  print(r, " : ", factor)
    
#for r in (34243.09290595, 24805.50428408,  31234.84324982,  24273.94286383, 19752.89087238):    
 #   factor = colebrook.bntFriction(r , 4.6666666666666665e-05) #diameter = 150mm
  #  print(r, " : ", factor)
